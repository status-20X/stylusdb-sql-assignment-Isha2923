...
const {parseQuery, parseQueryWhere ,parseQuerySix,parseQueryEight} = require('../../src/queryParser');
const {executeSELECTQuery,executeSELECTQueryfour,executeSELECTQuerywhere,executeSELECTQuerySix,executeSELECTQuerySeven,executeSELECTQueryEight} = require('../../src/index');
...
test('Parse SQL Query with INNER JOIN', async () => {
    ...
    const result = await parseQueryEight(query);
...
test('Execute SQL Query with INNER JOIN', async () => {
    const query = 'SELECT student.name, enrollment.course FROM student INNER JOIN enrollment ON student.id=enrollment.student_id';
    const result = await executeSELECTQueryEight(query);
    /*
    result = [
